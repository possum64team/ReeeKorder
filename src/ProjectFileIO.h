...
/// of ReeeKorder project file formats, and autosave
...
public:
   ...
   static ProjectFileIO &Get( ReeeKorderProject &project );
   static const ProjectFileIO &Get( const ReeeKorderProject &project );

   explicit ProjectFileIO( ReeeKorderProject &project );
...
class TitleRestorer{
public:
   TitleRestorer( wxTopLevelWindow &window, ReeeKorderProject &project );
   ~TitleRestorer();
...
private:
   std::shared_ptr<ReeeKorderProject> mpProject;
};
