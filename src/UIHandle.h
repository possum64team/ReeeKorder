...
public:
   ...
   virtual void Enter(bool forward, ReeeKorderProject *pProject);
   ...
   // Default does nothing and returns false
   virtual bool Escape(ReeeKorderProject *pProject);
   ...
   virtual Result Click
      (const TrackPanelMouseEvent &event, ReeeKorderProject *pProject) = 0;
   ...
   virtual HitTestPreview Preview
      (const TrackPanelMouseState &state, ReeeKorderProject *pProject) = 0;
   ...
   // Assume previously Clicked and not yet Released or Cancelled.
   // Cancelled in return flags has no effect.
   virtual Result Cancel(ReeeKorderProject *pProject) = 0;
   ...
   // use?
   virtual void OnProjectChange(ReeeKorderProject *pProject);
