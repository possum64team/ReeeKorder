...
public:
   ...
   BenchmarkDialog( wxWindow *parent, ReeeKorderProject &project );
...
BenchmarkDialog::BenchmarkDialog(
   wxWindow *parent, ReeeKorderProject &project)
   :
...
void BenchmarkDialog::OnRun( wxCommandEvent & WXUNUSED(event))
{
   ...
   // This code will become part of libreeekorder,
   ...
   system("ls .reeekorder_temp/* | wc --lines");
#endif
