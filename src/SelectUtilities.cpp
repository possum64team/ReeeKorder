...
void SelectNone( ReeeKorderProject &project )
{
   auto &tracks = TrackList::Get( project );
   for (auto t : tracks.Any())
      t->SetSelected(false);
...
void SelectAllIfNone( ReeeKorderProject &project )
{
...
bool SelectAllIfNoneAndAllowed( ReeeKorderProject &project )
{
...
(ReeeKorderProject &project, Track *t, bool shift, bool ctrl, bool modifyState)
{
   auto &tracks = TrackList::Get( project );
...
void DoSelectAll(ReeeKorderProject &project)
{
   DoSelectTimeAndTracks( project, true, true );
}

void DoSelectAllAudio(ReeeKorderProject &project)
{
...
void DoSelectSomething(ReeeKorderProject &project)
{
   auto &tracks = TrackList::Get( project );
   auto &selectedRegion = ViewInfo::Get( project ).selectedRegion;
