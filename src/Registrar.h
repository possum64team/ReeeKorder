...
ReeeKorder will call providers RegisterNameOfThing() functions with
...
public:
   ...
   virtual void AddCommand(std::unique_ptr<ReeeKorderCommand> && WXUNUSED(command) ){;};
