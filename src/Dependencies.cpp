...
an ReeeKorder .aup file rather than ReeeKorder having its own copies of the
data.

*//*****************************************************************//**

\class DependencyDialog
\brief DependencyDialog shows dependencies of an ReeeKorderProject on 
AliasedFile s.

*//********************************************************************/

#include "ReeeKorder.h"
...
static void GetAllSeqBlocks(ReeeKorderProject *project,
...
// Given an ReeeKorder project and a hash mapping aliased block
...
void FindDependencies(ReeeKorderProject *project,
...
static void RemoveDependencies(ReeeKorderProject *project,
         ...
         S.StartHorizontalLay(wxALIGN_LEFT,0);
         {
            mFutureActionChoice =
               S.Id(FutureActionChoiceID).AddChoice(
                  ...
                  {
                     /*i18n-hint: One of the choices of what you want ReeeKorder to do when
                     * ReeeKorder finds a project depends on another file.*/
                     XO("Ask me") ,
                     /*i18n-hint: One of the choices of what you want ReeeKorder to do when
                     * ReeeKorder finds a project depends on another file.*/
...
bool ShowDependencyDialogIfNeeded(ReeeKorderProject *project,
                                  bool isSaving)
{
...
\n\nSome older ReeeKorder projects may not be self-contained, and care \n\
