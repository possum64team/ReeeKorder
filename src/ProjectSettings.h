...
{
public:
   static ProjectSettings &Get( ReeeKorderProject &project );
   static const ProjectSettings &Get( const ReeeKorderProject &project );
   ...
   explicit ProjectSettings( ReeeKorderProject &project );
