...
ConnectionPtr &ConnectionPtr::Get( ReeeKorderProject &project )
{
   auto &result =
...
const ConnectionPtr &ConnectionPtr::Get( const ReeeKorderProject &project )
{
