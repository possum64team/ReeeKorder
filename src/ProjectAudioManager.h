...
{
public:
   static ProjectAudioManager &Get( ReeeKorderProject &project );
   static const ProjectAudioManager &Get( const ReeeKorderProject &project );

   // Find suitable tracks to record into, or return an empty array.
   static WaveTrackArray ChooseExistingRecordingTracks(
      ReeeKorderProject &proj, bool selectedOnly,
   ...
   explicit ProjectAudioManager( ReeeKorderProject &project );
   ...
   bool DoRecord(ReeeKorderProject &project,
...
AUDACITY_DLL_API
AudioIOStartStreamOptions DefaultPlayOptions( ReeeKorderProject &project );
AUDACITY_DLL_API
AudioIOStartStreamOptions DefaultSpeedPlayOptions( ReeeKorderProject &project );
...
AUDACITY_DLL_API
PropertiesOfSelected GetPropertiesOfSelected(const ReeeKorderProject &proj);
