...
public:
   ...
   DBConnection(
      const std::weak_ptr<ReeeKorderProject> &pProject,
...
private:
   std::weak_ptr<ReeeKorderProject> mpProject;
   sqlite3 *mDB;
...
{
public:
   static ConnectionPtr &Get( ReeeKorderProject &project );
   static const ConnectionPtr &Get( const ReeeKorderProject &project );
