...
void AudioIOBase::SetCaptureMeter(ReeeKorderProject *project, MeterPanelBase *meter)
{
...
void AudioIOBase::SetPlaybackMeter(ReeeKorderProject *project, MeterPanelBase *meter)
{
   if (( mOwningProject ) && ( mOwningProject != project))
      return;
