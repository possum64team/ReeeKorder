...
HistoryDialog::HistoryDialog(ReeeKorderProject *parent, UndoManager *manager):
...
ReeeKorderProject::AttachedWindows::RegisteredFactory sHistoryWindowKey{
...
AttachedItem sAttachment{ wxT("View/Windows"),
   ...
   // in ReeeKorderProject::UpdateMenus() (ugly)
   ...
   // ReeeKorderProject::UpdateMenus(), if somebody decides to do it:
