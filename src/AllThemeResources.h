...
from there.  ReeeKorder will look for a file called "Pause.png".
...
#define LOGOWITHNAME_HEIGHT 200
   ...
   SET_THEME_FLAGS( resFlagNewLine );
   DEFINE_IMAGE( bmpReeeKorderLogo48x48, wxImage( 48, 48 ), wxT("ReeeKorderLogo48x48"));
