   ...
   , public std::enable_shared_from_this<Track> // see SharedPointer()
{
 ...
 public:
   ...
   virtual Holder PasteInto( ReeeKorderProject & ) const = 0;
   ...
   , public ClientData::Base
{
 ...
 public:
   static TrackList &Get( ReeeKorderProject &project );
   static const TrackList &Get( const ReeeKorderProject &project );
 
   // Create an empty TrackList
   // Don't call directly -- use Create() instead
   explicit TrackList( ReeeKorderProject *pOwner );

   // Create an empty TrackList
   static std::shared_ptr<TrackList> Create( ReeeKorderProject *pOwner );
   ...
   ReeeKorderProject *GetOwner() { return mOwner; }
   const ReeeKorderProject *GetOwner() const { return mOwner; }
